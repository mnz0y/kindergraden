    ...
    <div className='footer'>
        ...
        <Col className="rightBox" >
            ...
            <div className="contact">
                ...
                <div className="sns">
                    <img src={process.env.PUBLIC_URL + "/img/facebook.svg"} alt="페이스북" />
                    <img src={process.env.PUBLIC_URL + "/img/youtube.svg"} alt="유투브" />
                    <img src={process.env.PUBLIC_URL + "/img/insta.svg"} alt="인스타그램" />
                </div>
            </div>
        </Col>
